...
__all__ = [
    '_VBComponent', 'vbextFileTypeExe', '_VBProjects_Old',
    'vbext_ws_Normal', '_Components', 'CodePanes',
    '_ReferencesEvents', 'vbext_ct_ClassModule',
    'vbext_wt_PropertyWindow', 'vbext_VBAMode', 'vbext_ct_StdModule',
    'vbextFileTypeForm', 'vbext_ProjectType', 'Properties',
    'VBComponent', 'vbext_wt_FindReplace', '_CodePanes',
    '_CommandBarControlEvents', '_VBProject_Old', 'VBComponents',
    '_VBComponentsEvents', 'vbext_pt_StandAlone',
    'vbext_wt_Immediate', 'vbextFileTypeBinary', '_ProjectTemplate',
    'vbext_ComponentType', 'VBProjects', 'Component', 'VBE',
    'VBProject', 'vbext_wt_MainWindow', '_References',
    '_dispReferencesEvents', '_CodePane', '_AddIns',
    'vbext_ws_Minimize', 'vbextFileTypeDocObject', 'vbext_pk_Get',
    'vbextFileTypePropertyPage', 'CodePane',
    'vbext_ct_ActiveXDesigner', 'AddIn', '_Properties',
    'vbextFileTypeFrx', '_Windows', 'vbext_wt_CodeWindow',
    '_dispVBComponentsEvents', '_CodeModule', 'References',
    'vbext_rk_TypeLib', 'vbextFileTypeUserControl',
    'vbext_rk_Project', 'vbext_cv_ProcedureView', 'vbext_wt_Locals',
    'vbext_ProjectProtection', 'ProjectTemplate', 'Events',
    '_LinkedWindows', '_dispReferences_Events', '_VBProject',
    'vbext_WindowType', '_VBProjectsEvents', 'Components',
    'vbext_wt_ToolWindow', 'vbext_RefKind', 'vbext_wt_Toolbox',
    'vbext_wt_LinkedWindowFrame', 'vbextFileTypeDesigners',
    'vbext_wt_Watch', 'vbext_ProcKind', '_dispVBProjectsEvents',
    'vbext_ct_MSForm', 'vbext_ct_Document', 'vbextFileTypes',
    'vbext_vm_Design', 'Addins', 'vbext_pk_Set', '_VBComponent_Old',
    'CommandBarEvents', 'vbext_pp_locked', '_Windows_old',
    'vbext_wt_Browser', '_VBComponents_Old', 'vbext_WindowState',
    'vbext_pt_HostProject', 'vbext_pp_none', 'vbext_ws_Maximize',
    'vbext_wt_Designer', 'vbextFileTypeModule', 'Window',
    '_dispCommandBarControlEvents', '_Component', 'vbext_pk_Let',
    'vbext_vm_Run', 'vbext_cv_FullModuleView', 'vbextFileTypeClass',
    'vbext_wt_Find', 'vbext_CodePaneview', '_VBComponents',
    'vbext_pk_Proc', 'vbext_wt_ProjectWindow',
    'vbextFileTypeGroupProject', 'vbextFileTypeRes', 'Windows',
    'ReferencesEvents', 'vbextFileTypeProject', 'Property',
    'Application', 'Reference', 'LinkedWindows', 'SelectedComponents',
    '_VBProjects', 'CodeModule', 'vbext_vm_Break'
]

_check_version('1.1.14', 1628993874.658932)
